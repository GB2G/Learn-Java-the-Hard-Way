public class ArraySlotAccess {
    ...
    public static void main(String[] args) {
        ...
        //We almost always use a for loop to access each slot in an array
        ...
        ////////////////////////////////////////
        // Put a random number 1-100 into each slot in the array, one at a time
        arr[0] = 1 + (int)(Math.random()*100);
        arr[1] = 1 + (int)(Math.random()*100);
        arr[2] = 1 + (int)(Math.random()*100);

        //Display them again, 1 at a time
        System.out.println("Values: "+ arr[0] +" "+ arr[1] +" "+ arr[2] );

        //////////////////////////////////////////
        //This is a bit silly but need to underrstand it
        int m = 0;
        ...
        ///////////////////////////////////////
        //Even sillier but it still works
